...
test("maintenance control is a fixed manual current-main exact-CI pinned-SSH workflow", () => {
  ...
  assert.deepEqual(workflows["production-maintenance"].on.workflow_dispatch.inputs.action.options, ["diagnose-runtime", "diagnose-pm2-peer", "plan", "prepare", "recover-held", "continue-held", "recover-build", "recover-attempt", "recover-second-attempt", "recover-budget", "renew-window", "recover-prelaunch", "recover-preflight", "renew-lease", "check", "end"]);
