...
const stages = [
  ...
  "web_capture_state", "state_preconditions", "state_pair_before", "state_worker_before", "state_web_before", "state_process_before",
  "state_environment", "state_build", "state_file_comparison", "state_process_environment",
  "state_environment_comparison", "state_current_after", "state_pair_after", "state_worker_after", "state_web_after", "state_process_after",
