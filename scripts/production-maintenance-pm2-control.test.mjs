...
test("fixed PM2 control protocol and real isolated Linux peer tests never use a PM2 daemon", () => {
  const script = fileURLToPath(new URL("./test_production_maintenance_pm2_control.py", import.meta.url));
