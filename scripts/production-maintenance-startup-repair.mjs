...
export function validateStartupRepairState(state,clock){
  const a=state.startupRepair;if(!exact(a,AUDIT)||a.version!==1)fail();
  validateStartupRepairPredecessor(a.predecessor,clock);
...
export function buildStartupRepairedState(previous,audit,clock){
  validateStartupRepairPredecessor(previous,clock);
