...
The additive POST on `/api/orders/catalog/public` accepts 1-32 block IDs, with a
...
The original GET implementation is unchanged for editors and existing clients.
...
Local acceptance before publication: the focused release suite passed 229/229,
