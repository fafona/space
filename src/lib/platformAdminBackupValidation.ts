...
Object.assign(cardFields, {
  ...
  qr: object({ x: number(0, 2000, true), y: number(0, 2000, true), size: number(48, 600, true),
    ...
    topText: object({ enabled: bool, text: qrCaption, font: oneOf(BUSINESS_CARD_QR_TEXT_FONTS.map(f => f.id)), fontSize: number(12, 64, true), color: qrColor, offsetX: number(-120, 120, true), offsetY: number(-300, 300, true) }),
    bottomText: object({ enabled: bool, text: qrCaption, font: oneOf(BUSINESS_CARD_QR_TEXT_FONTS.map(f => f.id)), fontSize: number(12, 64, true), color: qrColor, offsetX: number(-120, 120, true), offsetY: number(-300, 300, true) }) }),
