...
import { FAOLLA_LEGAL_DOCUMENTS, getFaollaLegalDocument } from "@/lib/faollaLegalContent";
import {
  FAOLLA_MOBILE_LEGAL_KEY_TO_VIEW as LEGAL_KEY_TO_VIEW,
  FAOLLA_MOBILE_LEGAL_VIEW_TO_KEY as LEGAL_VIEW_TO_KEY,
