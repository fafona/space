    ...
    <div ref={containerRef} className="relative">
      ...
      {open ? (
        <div className="absolute left-0 top-full z-30 mt-2 w-[240px] max-w-[calc(100vw-2rem)] rounded-2xl border border-slate-200 bg-white p-2 shadow-[0_16px_38px_rgba(15,23,42,0.14)]">
          <button
            type="button"
            className={`flex w-full items-center justify-between gap-3 rounded-xl border px-3 py-2 transition ${allSelected ? "border-slate-900 bg-slate-900 text-white" : "border-slate-200 bg-slate-50 text-slate-800 hover:bg-slate-100"}`}
            onClick={toggleAll}
          >
